...
const KitchenServiceStaff = () => {
  ...
  const [deliverFoodByKitchenStaff, deliverFoodByKitchenStaffRes] =
    useDeliverFoodByKitchenServiceStaffMutation();
  ...
  return (
    <>
      ...
      <ServiceDetailsDialogRequests
        ...
        setServiceDetailsDialog={setServiceDetailsDialog}
        deliverFoodByKitchenStaff={deliverFoodByKitchenStaff}
        handleCloseServiceDetailsDialog={handleCloseServiceDetailsDialog}
        setSnack={setSnack}
      />

      <LoadingComponent
        open={isLoading || deliverFoodByKitchenStaffRes.isLoading}
      />
...
const ServiceDetailsDialogRequests = ({
  ...
  }, [deliverFoodByKitchenStaff, serviceDetailsDialog]);
...
const OrderCardForCounterStaff = ({
...
export default KitchenServiceStaff;
